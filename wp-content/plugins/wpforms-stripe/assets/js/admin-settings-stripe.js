...
var WPFormsSettingsStripe = window.WPFormsSettingsStripe || ( function( document, window, $ ) {
	...
	var app = {
		...
		events: function() {
			...
			$( document ).on( 'change', $el.paymentCollectionTypeInputs.selector, app.triggerPaymentCollectionAlert );

			$( document ).on( 'change', $el.testModeCheckbox.selector, app.triggerModeSwitchAlert );
